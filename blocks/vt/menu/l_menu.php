...
$mirnaya='<div class="fon lm"><div class="fon_head"><h4>Ловля мирной рыбы:</h4></div><nav><ul><li><a href="/донка/">Донная ловля</a></li></ul></nav></div>';
$zimnyaya='<div class="fon lm"><div class="fon_head"><h4>Зимняя рыбалка:</h4></div><nav><ul><li><a href="/зимний-спиннинг/">Зимний спиннинг</a></li><li><a href="/зимние-снасти/">Зимние снасти</a></li></ul></nav></div>';
$polza='<div class="fon lm"><div class="fon_head"><h4>Полезно знать:</h4></div><nav><ul><li><a href="/рыбалка-и-закон/">Рыбалка и Закон</a></li></ul></nav></div>';
\lib\Def\Opt::$l_content=$school.$vodoem.$hishnik.$mirnaya.$zimnyaya.$polza;