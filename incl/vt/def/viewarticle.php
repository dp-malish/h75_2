...
class ViewArticle{
  ...
  protected function viewText($table_name,$table_name_img,$uri_part=0,$button_back=''){
    ...
    if($res['title']!=''){
      ...
      Def\Opt::$main_content.='<section><div class="fon_c"><article><h3>'.$res['caption'].'</h3><div class="cl"></div>'.$button_back.$img.$res['full_text'].'<p>'.$button_back.'</p></article><div class="cl"></div></div></section>';
