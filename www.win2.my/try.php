...
$perechen=[
    ...
    ['Виїзд до','1','90.03'],
    ['Виїзд до обладнення2','1','120.13']
];

//lib\printer\pdf\White_Reporting\Invoice::getPdf(7,'31 серпня 2018 р.',$spd,$spd_bank,$spd_adress,$spd_inn,$kontr_agent,$kontr_agent_bank,$kontr_agent_adress,$kontr_agent_inn,$perechen);
