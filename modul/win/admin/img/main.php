...
if(\lib\Post\Post::issetPostArr()){
    ...
    if(isset($_POST['imgadd'])){
        ...
        foreach($img->imgExt as $v){
            Opt::$main_content.='<div class="fon_c"><p>'.Img\ImgExt::getImgDir($_POST['tableimg']).$v.'<div class="ac"><img class="five" src="'.Img\ImgExt::getImgDir($_POST['tableimg']).$v.'" alt="" style="max-width:200px"></div></p></div>';
        }
